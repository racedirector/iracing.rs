...
| --- | --- | --- |
| [`session-schema.yml`](session-schema.yml) | Baseline schema for `iracing_sdk::schema::SessionInfo`. | `cargo session schema type --output ./docs/reference/session-schema.yml` |
...
| [`live-session-schema.yml`](live-session-schema.yml) | Schema generated from live session YAML. Windows-only. | `cargo session schema live --output ./docs/reference/live-session-schema.yml` |
