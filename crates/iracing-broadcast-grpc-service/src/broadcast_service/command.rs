...
pub(crate) fn camera_state(state: u32) -> iracing_sdk::irsdk::CameraState {
    iracing_sdk::irsdk::CameraState::from_bits_retain(state)
}

pub(crate) fn replay_position_mode(
    mode: ReplayPositionMode,
) -> iracing_sdk::irsdk::ReplayPositionMode {
    match mode {
        ReplayPositionMode::Begin => iracing_sdk::irsdk::ReplayPositionMode::Begin,
        ReplayPositionMode::Current => iracing_sdk::irsdk::ReplayPositionMode::Current,
        ReplayPositionMode::End => iracing_sdk::irsdk::ReplayPositionMode::End,
        ReplayPositionMode::Unknown => unreachable!("unknown replay position mode is rejected"),
    }
}

pub(crate) fn replay_search_mode(mode: ReplaySearchMode) -> iracing_sdk::irsdk::ReplaySearchMode {
    match mode {
        ReplaySearchMode::ToStart => iracing_sdk::irsdk::ReplaySearchMode::ToStart,
        ReplaySearchMode::ToEnd => iracing_sdk::irsdk::ReplaySearchMode::ToEnd,
        ReplaySearchMode::PreviousSession => iracing_sdk::irsdk::ReplaySearchMode::PreviousSession,
        ReplaySearchMode::NextSession => iracing_sdk::irsdk::ReplaySearchMode::NextSession,
        ReplaySearchMode::PreviousLap => iracing_sdk::irsdk::ReplaySearchMode::PreviousLap,
        ReplaySearchMode::NextLap => iracing_sdk::irsdk::ReplaySearchMode::NextLap,
        ReplaySearchMode::PreviousFrame => iracing_sdk::irsdk::ReplaySearchMode::PreviousFrame,
        ReplaySearchMode::NextFrame => iracing_sdk::irsdk::ReplaySearchMode::NextFrame,
        ReplaySearchMode::PreviousIncident => {
            iracing_sdk::irsdk::ReplaySearchMode::PreviousIncident
        }
        ReplaySearchMode::NextIncident => iracing_sdk::irsdk::ReplaySearchMode::NextIncident,
        ReplaySearchMode::Unknown => unreachable!("unknown replay search mode is rejected"),
    }
}

pub(crate) fn replay_state_mode(mode: ReplayStateMode) -> iracing_sdk::irsdk::ReplayStateMode {
    match mode {
        ReplayStateMode::EraseTape => iracing_sdk::irsdk::ReplayStateMode::EraseTape,
...
pub(crate) fn chat_command(request: ChatCommandRequest) -> Result<BroadcastCommand, Status> {
    ...
    Ok(match mode {
        ...
        ChatCommandMode::BeginChat => {
            BroadcastCommand::ChatCommand(iracing_sdk::irsdk::ChatCommandMode::BeginChat)
        }
        ChatCommandMode::Reply => {
            BroadcastCommand::ChatCommand(iracing_sdk::irsdk::ChatCommandMode::Reply)
        }
        ChatCommandMode::Cancel => {
            BroadcastCommand::ChatCommand(iracing_sdk::irsdk::ChatCommandMode::Cancel)
        }
...
) -> iracing_sdk::irsdk::TelemetryCommandMode {
    match mode {
        TelemetryCommandMode::Stop => iracing_sdk::irsdk::TelemetryCommandMode::Stop,
        TelemetryCommandMode::Start => iracing_sdk::irsdk::TelemetryCommandMode::Start,
        TelemetryCommandMode::Restart => iracing_sdk::irsdk::TelemetryCommandMode::Restart,
        TelemetryCommandMode::Unknown => unreachable!("unknown telemetry command mode is rejected"),
    }
}

pub(crate) fn video_capture_mode(mode: VideoCaptureMode) -> iracing_sdk::irsdk::VideoCaptureMode {
    match mode {
        VideoCaptureMode::Screenshot => iracing_sdk::irsdk::VideoCaptureMode::TriggerScreenshot,
        VideoCaptureMode::Start => iracing_sdk::irsdk::VideoCaptureMode::StartVideoCapture,
        VideoCaptureMode::Stop => iracing_sdk::irsdk::VideoCaptureMode::EndVideoCapture,
        VideoCaptureMode::Toggle => iracing_sdk::irsdk::VideoCaptureMode::ToggleVideoCapture,
        VideoCaptureMode::ShowTimer => iracing_sdk::irsdk::VideoCaptureMode::ShowVideoTimer,
        VideoCaptureMode::HideTimer => iracing_sdk::irsdk::VideoCaptureMode::HideVideoTimer,
