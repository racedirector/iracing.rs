...
use super::{
    constants::{IRSDK_MAX_BUFS as IRSDK_MAX_BUFFERS, IRSDK_VERSION},
    error::header_validation_error,
    flags::StatusField,
    variable_buffer::VariableBuffer,
    variable_header::VariableHeader,
};
use crate::{ProtocolError, Result, irsdk::WireType};
...
impl Header {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if self.version != IRSDK_VERSION {
            return Err(ProtocolError::mismatched_version_error(self.version as u32));
        }
